...
import huellaglobal from "@/public/images/about/huellaglobal.webp";
...
function HeroSection() {
  ...
  return (
    <section className="px-5 sm:px-8 md:px-12 xl:px-20 pt-12 pb-8 xl:pt-20 xl:pb-12">
      <StaggerContainer className="max-w-7xl mx-auto flex flex-col xl:flex-row gap-8 xl:gap-20 items-start">
  ...
  return (
    <section className="px-5 sm:px-8 md:px-12 xl:px-20 py-12 lg:py-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 xl:gap-24 items-center">
        <Reveal
          direction="left"
          className="w-full lg:w-1/2 border border-neutral-300 p-4 md:p-8 lg:p-10 shrink-0"
        >
          <Image
            src={huellaglobal}
            alt={t("heading")}
        ...
        <StaggerContainer className="w-full lg:w-1/2">
          <Item>
            <span
              className="block w-14 md:w-20 h-px md:h-1 mb-3 md:mb-5 shrink-0 bg-cyan-800"
              aria-hidden
