...
export const RECORDS: Record<string, TraceRecordMeta> = {
  GG691445: {
    ...
    origin: "Moyobamba, Centro Poblado La Florida, Pinto Recodo, Lamas, San Martín, Perú",
    altitude: "1250 msnm",
  ...
  GG288501: {
    code: "GG - 288501",
    coffeeFarm: "Mr. Edwin",
    origin: "Moyobamba, Centro Poblado La Florida, Pinto Recodo, Lamas, San Martin, Perú",
    altitude: "1250 msnm",
    variety: "Obata",
  },
};
